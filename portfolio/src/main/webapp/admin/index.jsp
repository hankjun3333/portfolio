...
<body>
  <div class="adbody">
      ...
      <div class="admoom">
        <form id="member_log"  onsubmit="return login_btn()" action="./loginok.do" name="member_log" method="post">
          <div class="intotal"> 
            <div class="adin1">
              <input type="text" name="mid" id="login_id" class="loginid" value="" placeholder=" 아이디">
            </div>
            <div class="adin2">
              <input type="password" name="mpass" id="login_pass" class="loginpass" value="" placeholder="패스워드">
            </div>
          </div>
          <div class="adbt">

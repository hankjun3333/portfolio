...
<!-- //페이지 끝 여기 div 두개는 절대 건들지말자!!!!!!!!!!! -->

  <!-- footer 카피라이터 시작-->
  	<footer id="ft">
<%@ include file="./footer.jsp" %>
  	</footer>	<!-- // footer 카피라이터 종료 -->
</div>
<!-- //wrap -->
<script src="js/slick.min.js?v=<%=date%>"></script>
<script src="js/common.js?v=<%=date%>"></script>
<script src="js/swiper.min.js?v=<%=date%>"></script>
<script src="js/layout.js?v=<%=date%>"></script>
<script>
